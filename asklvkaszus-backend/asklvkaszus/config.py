...
class Config:
    ...
    REDIS_SERVER_URI = f'redis://{REDIS_USERNAME}:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}'
    REDIS_LIMITER_URI = f'redis://{REDIS_USERNAME}:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}/{REDIS_RATE_LIMITING_DB}'
    REDIS_BLACKLISTED_TOKENS_URI = f'redis://{REDIS_USERNAME}:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}/{REDIS_BLACKLISTED_TOKENS_DB}'
