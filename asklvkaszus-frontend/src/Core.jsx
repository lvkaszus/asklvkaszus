...
import MinimalErrorBoundary from './components/errors/MinimalErrorBoundary.jsx';
...
const GlobalErrorBoundary = React.lazy(() => import('./components/errors/GlobalErrorBoundary.jsx'));
...
const NotFoundError = lazy(() => import("./components/errors/NotFoundError.jsx"))
              ...
              <Router>
                <Suspense fallback={<SuspenseFallback />}>
                  <Routes>
                    ...
                    <Route exact path="/" element={<Home handleFetchUserAppSettingsRequest={handleFetchUserAppSettingsRequest} isUserAppSettingsNotificationOpen={isUserAppSettingsNotificationOpen} userAppSettingsError={userAppSettingsError} userAppSettingsResponse={userAppSettingsResponse} handleUserAppSettingsNotificationClose={handleUserAppSettingsNotificationClose} />} />
                    ...
                    <Route exact path="/admin/home" element={ <AdminHome handleFetchAdminAppSettingsRequest={handleFetchAdminAppSettingsRequest} forceAdminAppSettingsDataFetch={forceAdminAppSettingsDataFetch} isAdminAppSettingsNotificationOpen={isAdminAppSettingsNotificationOpen} adminAppSettingsError={adminAppSettingsError} adminAppSettingsResponse={adminAppSettingsResponse} handleAdminAppSettingsNotificationClose={handleAdminAppSettingsNotificationClose} updateChecks={updateChecks} setUpdateChecks={setUpdateChecks} /> } />

                    <Route path="/admin/global_settings" element={ <AdminGlobalSettings handleFetchAdminAppSettingsRequest={handleFetchAdminAppSettingsRequest} forceAdminAppSettingsDataFetch={forceAdminAppSettingsDataFetch} isAdminAppSettingsNotificationOpen={isAdminAppSettingsNotificationOpen} adminAppSettingsError={adminAppSettingsError} adminAppSettingsResponse={adminAppSettingsResponse} handleAdminAppSettingsNotificationClose={handleAdminAppSettingsNotificationClose} handleForceAdminAppSettingsDataFetch={handleAdminAppSettingsUpdate} updateChecks={updateChecks} setUpdateChecks={setUpdateChecks} /> } />

                    <Route path="/admin/user_settings" element={ <AdminUserSettings handleFetchAdminAppSettingsRequest={handleFetchAdminAppSettingsRequest} forceAdminAppSettingsDataFetch={forceAdminAppSettingsDataFetch} isAdminAppSettingsNotificationOpen={isAdminAppSettingsNotificationOpen} adminAppSettingsError={adminAppSettingsError} adminAppSettingsResponse={adminAppSettingsResponse} handleAdminAppSettingsNotificationClose={handleAdminAppSettingsNotificationClose} updateChecks={updateChecks} setUpdateChecks={setUpdateChecks} /> } />

                    <Route path="/admin/management" element={ <AdminManagement handleFetchAdminAppSettingsRequest={handleFetchAdminAppSettingsRequest} forceAdminAppSettingsDataFetch={forceAdminAppSettingsDataFetch} isAdminAppSettingsNotificationOpen={isAdminAppSettingsNotificationOpen} adminAppSettingsError={adminAppSettingsError} adminAppSettingsResponse={adminAppSettingsResponse} handleAdminAppSettingsNotificationClose={handleAdminAppSettingsNotificationClose} updateChecks={updateChecks} setUpdateChecks={setUpdateChecks} /> } />
